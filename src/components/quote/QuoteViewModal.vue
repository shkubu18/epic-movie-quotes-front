...
import QuoteViewModalHeader from '@/components/quote/QuoteViewModalHeader.vue'
import QuoteViewModalArticle from '@/components/quote/QuoteViewModalArticle.vue'
