...
import LandingHeading from '@/components/landing/LandingHeading.vue'
import LandingArticle from '@/components/landing/LandingArticle.vue'
import LandingSpan from '@/components/landing/LandingSpan.vue'
</script>